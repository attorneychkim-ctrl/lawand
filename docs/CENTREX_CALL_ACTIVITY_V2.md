...
일반 내선 수신은 고객 해석 대신 수신 leg의 상대 내선과 발신 leg endpoint를
활성·검증된 직원 통화 binding에 대조한다. 알림 제목에 발신 직원명, 본문에
발신 내선·소속·부서·직책·지역과 수신 직원·내선을 표시한다. 수신 leg만
먼저 도착한 시점에도 상대 내선으로 즉시 해석하며, 동일 내선 후보가 복수면 모두
표시하고 미등록 내선은 임의의 직원으로 추정하지 않는다. 수신 leg와 수신 직원이
확인되기 전에는 발신자 자신에게 수신 알림을 보내지 않는다.
