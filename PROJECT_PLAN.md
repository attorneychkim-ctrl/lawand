# 로앤 통합 플랫폼 — 프로젝트 설계·구현 기준선 (v0.96)
...
- [ ] 운영 migration `0041`·SOLAPI 등록 MMS 발신번호 설정 → 통제 SMS/LMS·명함 MMS 각 1건 canary
...
8. 고객 문자 migration `0041`·SOLAPI 등록 MMS 발신번호를 적용하고 통제 SMS/LMS·명함 MMS
   각 1건 canary 뒤, Solapi 최종 발송결과 자동 수신과 전체 상담 상태머신 확정
