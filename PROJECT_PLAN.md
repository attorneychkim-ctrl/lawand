...
스토리지 파일 ID·미리보기 URL·크기·해상도만 보존한다. 고객 번호와 본문은 outbox·로그에
...
8. SOLAPI 명함 JPG MMS 1건 canary 뒤, Solapi 최종 발송결과 자동 수신과 전체 상담
   상태머신 확정
9. 대표 문자 수신함 migration·계정 검증 연결 뒤 `02-555-7465` 통제 회신 1건의
   Case_idx 통합 대화 canary; 대표전화 근무/휴무·담당자 조건 라우팅은 별도 설계
