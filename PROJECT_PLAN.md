...
직접 번호 대상은 migration `0058_message_conversation_composer.sql`의
...
- [x] `/messages` 대화형 작성 로컬 출시 후보: 대화·말풍선 각 50건 cursor 무한 로딩,
  ...
  ERP·리걸프렌즈·직접 번호 새 메시지 모달, `0058` 암호화 직접 대상 원장·비식별 outbox
- [ ] 운영 migration `0058`·gateway/ERP 통합 배포 → 기존 Case_idx/상담 대화 보존,
