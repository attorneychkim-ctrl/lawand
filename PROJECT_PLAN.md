# 로앤 통합 플랫폼 — 프로젝트 설계·구현 기준선 (v1.49)
...
>
> 최신 운영 반영(2026-08-16): 공개 후기 작성자 자동 마스킹과 ERP 후기 요청 템플릿
> 선택·문자 미리보기·편집 UX를 소스 `d4b503934506b5f9c3b6206c039f424b77ebcc1e`, 릴리스
> `20260816T035427Z-review-privacy-template-editor-v1`로 홈페이지·ERP·gateway에 함께
> 배포했다. migration·스키마·운영 데이터·Windows bridge는 변경하지 않았다.
...
>
> 2026-08-18 구현 후보: ERP 상담페이지의 직원 신규등록과 전화데스크 통화 후처리의
...
>
> 2026-08-18 후보에서는 직원별 문자 템플릿에 담당자배정·부재 및 무응답·통화중·
...
> 배포 후보를 구현했다. 승인 계정의 실제 상품 목록에서 메가MGC커피 더블 아아 세트,
...
> gateway에 구현했다. 운영 migration·앱 배포는 하지 않았다.
>
