...
export const metadata: Metadata = {
  title: "개인정보처리방침",
  description:
    "법무법인 로앤 홈페이지의 상담 요청, 고객후기, 카카오톡 상담 진입 및 네이버 예약 관련 개인정보 처리 기준을 안내합니다.",
  alternates: {
    canonical: pagePath,
  },
  openGraph: {
          ...
          <article className="legal-document">
            <section id="summary">
              ...
              <p className="legal-callout">
                이 방침은 공개 홈페이지 이용과 계약 전 상담·후기 접수에
                적용됩니다. 위임계약 체결 뒤 사건 수행에 필요한 개인정보는 계약
                내용과 관계 법령에 따른 별도 기준으로 처리합니다.
              </p>
            </section>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        홈페이지를 통한 채팅 진입 대기 접수, 반복 클릭의
                        중복 방지, 실제 채팅 확인 또는 미진입 처리
                      </td>
                      <td>
                        브라우저 세션의 가명 접수키, 진입 위치, 최초·최근 클릭
                        시각과 횟수, 내부 접수명·접수번호, 직원 확인 후 카카오
                        채널 표시명
                        <br />
                        <em>
                          홈페이지는 카카오 사용자 ID, 메시지 원문과 전화번호를
                          자동으로 받지 않습니다.
                        </em>
                      </td>
                      <td>
            ...
            <section id="collection">
              ...
              <h2>개인정보의 수집 방법</h2>
              <ul>
                <li>정보주체가 홈페이지 상담·후기 양식에 직접 입력하는 방법</li>
                <li>
            ...
            <section id="automatic">
              ...
              <p>
                현재 홈페이지는 맞춤형 광고를 위한 제3자 추적 쿠키를 설치하지
                않습니다. 브라우저 설정에서 사이트 데이터 저장을 거부하거나
                삭제할 수 있지만, 이 경우 중복 요청 방지나 유입 경로 연결이
                정확하지 않을 수 있습니다.
              </p>
              <h3>자동화된 처리</h3>
              <p>
                로앤은 중복 접수 분류, 담당자 배정 후 외부 시스템 등록과 알림
                발송을 자동화할 수 있습니다. 이러한 자동화는 법률 판단, 사건
                수임 여부 또는 재판 결과를 자동 결정하지 않습니다. 담당 직원과
                변호사가 상담·계약·법률 판단과 중요한 고객 안내를 확인하고
                책임집니다.
              </p>
            </section>
