        ...
        <div className="shell legal-layout">
          ...
          <article className="legal-document">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <em>
                          ...
                          식별자가 아닙니다. 확인이 필요한 이름 형식은 원문을
                          저장하지 않고 검토 표기로 바꿉니다. 휴대전화 번호는
                          고객이 선택해 입력한 경우에만 받으며, 카카오 사용자
                          ID와 메시지 원문은 받지 않습니다.
                        </em>
                      </td>
                      <td>
            ...
            <section id="security">
              ...
              <ul>
                <li>
                  상담 연락처·검증된 이름·지역·상담 원문과 비공개 후기 원문을
                  인증 암호화해 저장하고 전송 구간을 보호합니다. 확인이 필요한
                  고객명 원문은 저장하지 않고 검토 표기로 바꿉니다.
                </li>
                <li>
