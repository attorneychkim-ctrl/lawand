                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        고객 입력 이름으로 카카오 채팅 확인, 상담 접수와 담당
                        배정, 반복 제출의 중복 방지, 미진입 처리
                      </td>
                      <td>
                        고객이 입력한 이름 또는 카카오톡 표시명, 브라우저 세션의
                        가명 접수키, 진입 위치, 최초·최근 클릭 시각과 횟수,
                        내부 접수명·접수번호, 직원의 채팅 확인·담당 배정 기록
                        <br />
                        <em>
                          입력 이름은 채팅을 찾는 단서이며 카카오가 보증한
                          식별자가 아닙니다. 홈페이지는 카카오 사용자 ID, 메시지
                          원문과 전화번호를 자동으로 받지 않습니다.
                        </em>
                      </td>
                      <td>
