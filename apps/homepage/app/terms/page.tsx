...
export const metadata: Metadata = {
  title: "홈페이지 이용약관",
  description:
    "법무법인 로앤 홈페이지의 정보 제공, 상담 요청, 고객후기와 외부 상담 채널 이용 기준을 안내합니다.",
  alternates: {
    canonical: pagePath,
  },
  openGraph: {
        ...
        <div className="shell legal-layout">
          ...
          <article className="legal-document">
            ...
            <section id="external">
              ...
              <p>
                홈페이지 카카오톡 버튼을 누르면 로앤 ERP에 ‘채팅 확인 대기’
                접수가 생성될 수 있지만, 로앤은 일반 채널 링크만으로 실제
                채팅방 진입이나 메시지 전송 성공을 확인할 수 없습니다. 메시지를
                남기지 않은 접수는 운영자가 미진입·무효로 처리할 수 있습니다.
              </p>
            </section>
